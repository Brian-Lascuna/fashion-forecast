  ...
  fetch(geoURL + city + "&limit=5&" + APIkey)  // Search by city to get coordinates.
    ...
    .then(function (data) {
      ...
      .then(function (data) {
        ...
        //   weatherCards[i].children[0].children[0].attributes[0].nodeValue = iconURLprefix + data.daily[i].weather[0].icon + '@2x.png';
...
var getForecast = function (place) {
    document.location.replace('./search.html?q=' + place);
};
